...
class ArrayOfAPIHotelDetails implements \ArrayAccess, \Iterator, \Countable
{
     ...
     * @param APIHotelDetails $value The value to set
     * @return void
     */
     ...
     *
     * @return APIHotelDetails Return the current element
     */
     ...
     *
     * @return APIHotelDetails Return count of elements
     */
