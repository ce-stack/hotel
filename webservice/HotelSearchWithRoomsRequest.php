...
class HotelSearchWithRoomsRequest
{
    ...
    /**
     * @var HotelSearchWithRoomsFilters $Filters
     */
     ...
     */
    protected $IsCancellationPolicyRequired = null;
     ...
     * @param HotelSearchWithRoomsFilters $Filters
     * @param int $ResponseTime
     * @param boolean $IsCancellationPolicyRequired
     */
    public function __construct(\DateTime $CheckInDate, \DateTime $CheckOutDate, $CountryName, $CityName, $CityId, $IsNearBySearchAllowed, $NoOfRooms, $GuestNationality, $RoomGuests, $PreferredCurrencyCode, $ResultCount, $Filters, $ResponseTime, $IsCancellationPolicyRequired)
    {
     ...
     * @return HotelSearchWithRoomsRequest
     */
    public function setIsCancellationPolicyRequired($IsCancellationPolicyRequired)
    {
      $this->IsCancellationPolicyRequired = $IsCancellationPolicyRequired;
      return $this;
    }
