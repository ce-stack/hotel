...
class HotelBookRequest
{
     ...
     */
    protected $AgencyReferenceNumber = null;

    /**
     * @var boolean $RestrictDuplicateBooking
     */
    protected $RestrictDuplicateBooking = null;
     ...
     */
    public function __construct($ClientReferenceNumber, $GuestNationality, $Guests, $AddressInfo, $PaymentInfo, $SessionId, $FlightInfo, $NoOfRooms, $ResultIndex, $HotelCode, $HotelName, $HotelRooms, $SpecialRequests, $AgencyReferenceNumber, $RestrictDuplicateBooking)
    {
     ...
     * @return HotelBookRequest
     */
    public function setRestrictDuplicateBooking($RestrictDuplicateBooking)
    {
      $this->RestrictDuplicateBooking = $RestrictDuplicateBooking;
      return $this;
    }
