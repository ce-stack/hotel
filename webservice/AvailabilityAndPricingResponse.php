...
class AvailabilityAndPricingResponse
{
     ...
     */
    public function __construct($Status, $ResultIndex, $AvailableForBook, $AvailableForConfirmBook, $CancellationPoliciesAvailable, $HotelCancellationPolicies, $PriceVerification, $AccountInfo, $HotelDetailsVerification, $HotelDetails)
    {
      $this->Status = $Status;
