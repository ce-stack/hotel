...
class APIBookingDetail
{
    ...
    /**
     * @var RequestStatus $AmendmentStatus
     */
    protected $AmendmentStatus = null;
     ...
     * @param int $CityId
     * @param int $BookingId
     * @param RequestStatus $AmendmentStatus
     ...
     */
    public function __construct($Rating, $CheckInDate, $CheckOutDate, $BookingDate, $NoOfRooms, $CityId, $BookingId, $AmendmentStatus, $BookingStatus, $VoucherStatus, $InvoiceNumber, $SupplierReferenceNo, $ConfirmationNo, $HotelConfirmationNo)
    {
      $this->Rating = $Rating;
